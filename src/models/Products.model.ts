import { PrimaryGeneratedColumn,Column,UpdateDateColumn,CreateDateColumn,Entity,ManyToOne } from "typeorm";
...
@Entity({name: 'products'})
 export class Products {
    ...
    @Column({ type: 'decimal', precision: 10, scale: 2, name: 'offer_price', nullable: true })
