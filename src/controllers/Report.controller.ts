...
export class ReportController {
    ...
    getSalesByPeriod = async (req: Request, res: Response): Promise<void> => {
        try {
            ...
            const report = await this.reportService.getSalesByPeriod(startDate, endDate);
            res.status(200).json(report);
        } catch (error: any) {
            res.status(500).json({ error: error.message });
        }
    ...
    getTopProducts = async (req: Request, res: Response): Promise<void> => {
        try {
            ...
            const report = await this.reportService.getTopProducts(limit, startDate, endDate);
            res.status(200).json(report);
        } catch (error: any) {
            res.status(500).json({ error: error.message });
        }
    ...
    getEmployeePerformance = async (req: Request, res: Response): Promise<void> => {
        try {
            ...
            const report = await this.reportService.getEmployeePerformance(startDate, endDate);
            res.status(200).json(report);
        } catch (error: any) {
            res.status(500).json({ error: error.message });
        }
    ...
    getGrossProfit = async (req: Request, res: Response): Promise<void> => {
        try {
            ...
            const report = await this.reportService.getGrossProfit(startDate, endDate);
            res.status(200).json(report);
        } catch (error: any) {
            res.status(500).json({ error: error.message });
        }
